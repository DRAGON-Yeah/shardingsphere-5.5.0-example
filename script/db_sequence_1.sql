/*
 ...
 Source Schema         : db_sequence_1

 Target Server Type    : MySQL
 Target Server Version : 80033 (8.0.33)
 File Encoding         : 65001

 Date: 28/08/2024 22:41:03
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `sequence` (`id`, `sharding_key`, `name`, `value`, `gmt_modified`) VALUES (1, 1, 'user_seq', 7000, '2023-07-04 10:26:51');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sequence_0` (`id`, `sharding_key`, `name`, `value`, `gmt_modified`) VALUES (1, 1, 'user_seq', 19000, '2023-07-04 10:23:23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sequence_1` (`id`, `sharding_key`, `name`, `value`, `gmt_modified`) VALUES (1, 1, 'user_seq', 19000, '2023-07-04 10:23:23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sequence_2` (`id`, `sharding_key`, `name`, `value`, `gmt_modified`) VALUES (1, 1, 'user_seq', 19000, '2023-07-04 10:23:23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sequence_3` (`id`, `sharding_key`, `name`, `value`, `gmt_modified`) VALUES (1, 1, 'user_seq', 19000, '2023-07-04 10:23:23');
COMMIT;
